...
import { SignupType } from "@kind5/medium-common"
...
export const Auth = ({ type }: { type: "signup" | "signin" }) => {
    ...
    async function sendRequest() {
        try {
            const response = await axios.post(`${import.meta.env.VITE_REACT_APP_BACKEND_URL}/api/v1/user/${type === "signup" ? "signup" : "signin"}`, postInputs);
